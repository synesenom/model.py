...
def print_pmfs(data, fit_results, output_name):
    ...
    utils.print_csv(output_name, ['value', 'p_measured'] + dist.DISTRIBUTIONS, output)
...
def perform_aic_test(data, output_name):
    ...
    :param output_name: name of output file that contains the probability mass function of the original data and
    the fitted distributions with their optimal parameters.
    """
    print("AIC test")
